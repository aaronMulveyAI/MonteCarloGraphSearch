...
public class UCT2 extends MonteCarloTreeSearch {

    protected TranspositionTable TRANSPOSITIONS_TABLE;
    public final Stack<AbstractNode> PATH;

    public UCT2(iSearchStopCondition STOP_CONDITION) {
        super("UCT2", STOP_CONDITION, null);
    ...
    public void backpropagate(AbstractNode node, double winner) {
        ...
        if (((TreeNode) node).isLeaf()) {
            ...
            TRANSPOSITIONS_TABLE.updateAll(node, winner, 0);
        }
        node.update(winner);
    }
